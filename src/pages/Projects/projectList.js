...
import { BOOTSTRAP, DJANGO, EXPRESSJS, HTML, JAVA, JS, MYSQL, NODE, PYTHON, REACT, SASS } from "../../utils/svgImports";
...
export const projects = [
  {
    id: uuidv4(),
    name: "FurEver",
    description: "Tinder-like page that allows you to find pets more easily",
    img: "",
  ...
  },
  {
    id: uuidv4(),
    name: "FurEver",
    description: "API for the FurEver page",
    img: "",
    alt: "image of FurEver page",
