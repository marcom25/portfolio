  ...
  return (
    <Row className="bg-blur rounded-5  text-main-color flex-column gap-5">
      <Col className="d-flex gap-3 flex-column mt-5">
        ...
        <Row className="mb-5 mx-lg-5 gap-3 justify-content-center">
          {skills.map(skill => (
            <Col xs={3} md={2} lg={2} xl={1} className="d-flex align-items-center justify-content-center rounded-3 icons-bg " key={skill.name}>
